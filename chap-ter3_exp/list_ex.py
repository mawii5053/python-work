names = ['fizzy','azaya','john','matha','silverline']
print(names)
...
message = f"you can't out smart {names[0].title()}"
print(message)

message = f"you can't out smart {names[1].title()}"
print(message)
message = f"youcan't out smart {names[2].title()}"
print(message)
